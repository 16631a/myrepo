...
#    grayL = cv.cvtColor(imgL, cv.COLOR_BGR2GRAY)
 #   grayR = cv.cvtColor(imgR, cv.COLOR_BGR2GRAY)
    ...
    retL, cornersL = cv.findChessboardCorners(imgL, chessboardSize, None)
...
#retStereo, newCameraMatrixL, distL, newCameraMatrixR, distR, rot, trans, essentialMatrix, fundamentalMatrix = cv.stereoCalibrate(objpoints, imgpointsL, imgpointsR, newCameraMatrixL, distL, newCameraMatrixR, distR, imgL.shape[::-1], criteria_stereo, flags)
...
rectifyScale= 1
#rectL, rectR, projMatrixL, projMatrixR, Q, roi_L, roi_R= cv.stereoRectify(newCameraMatrixL, distL, newCameraMatrixR, distR, imgL.shape[::-1], rot, trans, rectifyScale,(0,0))
...
#stereoMapL = cv.initUndistortRectifyMap(newCameraMatrixL, distL, rectL, projMatrixL, imgL.shape[::-1], cv.CV_16SC2)
#stereoMapR = cv.initUndistortRectifyMap(newCameraMatrixR, distR, rectR, projMatrixR, imgR.shape[::-1], cv.CV_16SC2)
